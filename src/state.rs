...
impl<'a> State<'a> {
    pub async fn new(window: &'a Window) -> Self {
        ...
        let diffuse_texture = Texture::from_bytes(&device, &queue, include_bytes!("happy-tree.png"), "a tree").unwrap();
